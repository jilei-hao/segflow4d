...
def main():
    ...
    parser.add_argument("--output-mov", type=str, default="moved_image.nii.gz", help="Output path for moved image")
    ...
    # Save moved image
    print(f"\nSaving moved image to {args.output_mov} ...")
    reg.save_moved_images(moved, args.output_mov)

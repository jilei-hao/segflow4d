...
class TPPartitionInputGroup:
    ...
    seg_mesh_ref: MeshWrapper # mesh representation of the segmentation reference image
    additional_meshes_ref: dict[str, MeshWrapper] # additional mesh representations of structures in the segmentation reference image
